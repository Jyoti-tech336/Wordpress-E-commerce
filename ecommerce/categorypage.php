           ...
           $exe2= mysqli_query($connection,$q2);
            while($fetch2= mysqli_fetch_array($exe2)){ ?>
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector brand" value="<?php echo $fetch2['brand_id'];?>"  >&nbsp;&nbsp;<?php echo $fetch2['brand_name'];?> </label>
                    </div>
                    <?php
                    }
  ...
  location.replace("product.php")
	...
	<div class="row">
          ...
          <?php
             ...
             // include'connection.php';
         $cid=$_GET['cid'];
$select="select * from product where cloth_idd='$cid' order by rand()";
$exe= mysqli_query($connection,$select);
while($fetch= mysqli_fetch_array($exe)){ ?>
		<div class="col-md-4 mb-4">
			<div class="card">
				<img class="card-img-top img-hover-zoom " onclick="myFunction()" src="image/<?php echo $fetch['image1'];?>" alt="" />
				<div class="card-body">
                    <p class="h6"><?php echo $fetch['prd_name'];?><small class="text-muted"><br><?php echo $fetch['small_des'];?></small></p>
                    <p class="h5 m-0"><i class="fa fa-inr fa-sm" aria-hidden="true"></i> <?php echo $fetch['prd_price'];?> </p>
                  <p class="card-text"></p>
